...
<!--          <el-button round v-if=!isUpdate @click="publishShow">发布</el-button>-->
      ...
      <el-dialog title="摘要 分类 标签"
        ...
        <div slot="footer" class="dialog-footer">
          ...
          <el-button type="primary" v-if=!isUpdate @click="publish('articleForm')">发布</el-button>
          <el-button type="primary" v-if=isUpdate @click="update('articleForm')">修改</el-button>
        </div>
      </el-dialog>
    </el-container>
  </div>
...
<script>
  ...
  export default {
    ...
    methods: {
      getRouterData() {
        console.log('!!!!!!!!!!!')
        console.log(this.$route.query.isUpdate)
      ...
      update(articleForm) {
        ...
        this.$refs[articleForm].validate((valid) => {
          if (valid) {
            ...
            bodyId: this.articleForm.bodyId,
            }
